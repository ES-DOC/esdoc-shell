...
main()
{
	...
	if [ $1 = "all" ]; then
		...
		python $ESDOC_HOME/bash/cmip6/models/generate_pdf.py --institution-id=test-institute-1
		python $ESDOC_HOME/bash/cmip6/models/generate_pdf.py --institution-id=test-institute-2
		python $ESDOC_HOME/bash/cmip6/models/generate_pdf.py --institution-id=test-institute-3
	else
