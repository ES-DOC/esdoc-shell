...
main()
{
	...
	if [ $1 = "all" ]; then
		...
		python $ESDOC_DIR_BASH/cmip6/models/generate_pdf.py --institution-id=test-institute-1
		python $ESDOC_DIR_BASH/cmip6/models/generate_pdf.py --institution-id=test-institute-2
		python $ESDOC_DIR_BASH/cmip6/models/generate_pdf.py --institution-id=test-institute-3
	else
